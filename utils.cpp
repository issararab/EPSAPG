...
void help(bool detailed){
	...
	cout << "\n ++MANDATORY PARAMETERS \n"
		 ...
		 <<	"\n   MMseqs2 output result. For accurate statistics of the profile, provide the main database length.\n"
		 ...
		 <<	"\n   Enable or disable outputing alignment profile of a query sequence against a database. If disabled, it will print on console. (enabled by default)\n"
